...
# 创建子证书，绑定 IP 地址（可改为域名，例如 x509.DNSName("example.com")）
sub_cert = (
    ...
    .add_extension(
        x509.SubjectAlternativeName([x509.IPAddress(ip_address(ip))]),
        critical=False,
    )
    .add_extension(
